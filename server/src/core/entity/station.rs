...
pub fn new(world: &mut specs::World, name: String, owner: specs::Index) -> specs::Index {
...
mod tests {
    ...
    fn compare_station_ids() {
        ...
        let station1: specs::Index = new(&mut world, "ISS".to_string(), 1);
        let station2: specs::Index = new(&mut world, "Moon".to_string(), 2);
